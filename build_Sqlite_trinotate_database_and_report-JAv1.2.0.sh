...
function help
{
 ...
 Exemple Usage: ./"$softName"-JAv1.2.sh -f ./fasta -m julie.orjuela@ird.fr
 Usage: ./"$softName"-JAv1.2.0.sh -f $resultsDir -m obiwankenobi@jedi.force
	options:
...
if [ $repertory != "" ] ; then
	...
	signalp=$shortName".signalp.out"
	echo $shortName; echo $geneTransMap; echo $transdecoderPep;
